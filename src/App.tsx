...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#EDE7DC] text-[#2C3D56] font-sans selection:bg-[#D4A854]/20">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-[#E4EEF4]/80 backdrop-blur-md z-50 border-b border-[#B8CED9]/50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-[#D4A854] rounded-xl flex items-center justify-center text-white font-bold text-xl">C</div>
            <span className="font-bold text-xl tracking-tight text-[#2C3D56]">Les bébés Clém</span>
          </div>
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-[#4A6885]">
      ...
      <Section id="accueil" className="pt-32 pb-20 overflow-hidden">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold text-[#2C3D56] leading-[1.1] mb-6">
              Assistante Maternelle <br />
              <span className="text-[#D4A854] text-4xl md:text-5xl block mt-2">à Saint-Clément (19700)</span>
              <span className="text-[#7A9EB8] text-lg md:text-xl block mt-2 font-medium uppercase tracking-widest">Corrèze — Limousin</span>
            </h1>
            <div className="flex flex-col gap-2 mb-8">
              <p className="text-2xl font-semibold text-[#4A6885] flex items-center gap-3">
                <ShieldCheck className="text-[#D4A854]" size={28} />
                Agréée depuis 2011
              </p>
              <p className="text-xl italic text-[#7A9EB8] font-medium">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-3 px-6 py-4 bg-[#E4EEF4] rounded-2xl border border-[#B8CED9]/50 shadow-sm">
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 bg-green-500 rounded-full animate-pulse" />
                  <span className="text-sm font-bold text-[#4A6885]">2 places disponibles actuellement</span>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <Section id="a-propos" className="bg-[#E4EEF4]">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-lg text-[#4A6885] mb-6 leading-relaxed">
      ...
      <Section className="bg-[#B8CED9]/20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-[#2C3D56] mb-4">Expertise & Formations</h2>
          <p className="text-[#4A6885] max-w-2xl mx-auto">
      ...
      <Section id="services">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl font-bold text-[#2C3D56] mb-8">Un cadre de vie épanouissant</h2>
            <div className="space-y-8">
              <div className="flex gap-6">
                <div className="w-14 h-14 bg-[#D4A854]/20 rounded-2xl flex items-center justify-center shrink-0">
                  <Home className="text-[#D4A854]" size={28} />
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-2">Espaces dédiés</h3>
                  <p className="text-[#4A6885]">Un espace jeux à l'intérieur, un à l'extérieur et un dortoir entièrement dédiés à l'accueil des enfants.</p>
                </div>
              </div>
              <div className="flex gap-6">
                <div className="w-14 h-14 bg-[#4A6885]/20 rounded-2xl flex items-center justify-center shrink-0">
                  <Sun className="text-[#4A6885]" size={28} />
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-2">Activités variées</h3>
                  <p className="text-[#4A6885]">Éveil, motricité libre, lecture, activités manuelles et sorties en extérieur pour découvrir le monde.</p>
                </div>
              </div>
              <div className="flex gap-6">
                <div className="w-14 h-14 bg-[#B8CED9] rounded-2xl flex items-center justify-center shrink-0">
                  <Heart className="text-[#4A6885]" size={28} />
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-2">Soutien à la parentalité</h3>
                  <p className="text-[#4A6885]">J'aime partager mes connaissances avec les parents pour les soutenir dans leur rôle quotidien.</p>
                </div>
              </div>
            </div>
          </div>
          <div className="bg-[#2C3D56] rounded-[3rem] p-12 text-white">
          ...
          <div>
            ...
            <div className="space-y-8">
              <a href={`tel:${phoneNumber}`} className="flex items-center gap-6 group">
                ...
                <div>
                  <p className="text-[#7A9EB8] text-sm">Téléphone direct</p>
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <p className="text-[#7A9EB8] text-sm">Adresse</p>
              ...
              <a href="https://www.facebook.com/search/top?q=les%20b%C3%A9b%C3%A9s%20clem" target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 group">
                <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center group-hover:bg-[#4A6885] transition-colors">
                  <Facebook size={28} />
                </div>
                <div>
                  <p className="text-[#7A9EB8] text-sm">Suivez-moi</p>
